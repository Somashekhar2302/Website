...
header : {
  ...
  intro : {
    ...
    description : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam!',
    features : [
      ...
      {icon:'bolt', title:'Easy to Use', description:'Cu vero ipsum vim, doctus facilisi sea in. Eam ex falli honestatis repudiandae, sidetracto mediocrem disputationi'},
  ...
  clients : {
    ...
    companies : [
      ...
      {name:'Jusitce', weblink:'company-logo6.png', logo:'company-logo6.png'},
  ...
  footer: {
      copyrightText: 'Made with code',
      developer: 'Benki',
      developerlink: ''
  },
  socialsites:[
    {title:'Facebook', target:'_blank', username:'benki', icon:'facebook' },
    {title:'Google+', target:'_blank', username:'benki', icon:'google-plus' },
    {title:'Twitter', target:'_blank', username:'benki', icon:'twitter' },
    {title:'Instagram', target:'_blank', username:'benki', icon:'instagram' },
    {title:'behance', target:'_blank', username:'benki', icon:'behance' },
  ],
  blog:{
    tagline : 'My Blog',
    title : 'Rocky'
